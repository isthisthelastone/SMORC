import { CountdownBackground, Logo } from "@shared/assets";
import { EffectsWrapper } from "../../home";
import { Flex, SpecialBox, Typography } from "@shared/components";
...
export const CountdownSocials = ({ className }: CountdownSocialsProps) => (
  <Flex className={`${className} flex-col gap-[2rem] justify-center`}>
    <Typography className={"text-[1.25rem] text-center font-[600]"}>
      Join SMORC
    </Typography>
